...
internal sealed class ReviewedPvpCommandDispatcher
{
    ...
    private static string? ResolveExactHardcodedCommand(ReviewedPvpCommand command) => command switch
    {
        ...
        { Kind: ReviewedPvpCommandKind.GuardianCoveringTarget, Language: ClientLanguage.German, Slot: 1 } => "/quickchat <1> \"Ziel decken\"",
        { Kind: ReviewedPvpCommandKind.GuardianCoveringTarget, Language: ClientLanguage.German, Slot: 2 } => "/quickchat <2> \"Ziel decken\"",
        { Kind: ReviewedPvpCommandKind.GuardianCoveringTarget, Language: ClientLanguage.German, Slot: 3 } => "/quickchat <3> \"Ziel decken\"",
        { Kind: ReviewedPvpCommandKind.GuardianCoveringTarget, Language: ClientLanguage.German, Slot: 4 } => "/quickchat <4> \"Ziel decken\"",
        { Kind: ReviewedPvpCommandKind.GuardianCoveringTarget, Language: ClientLanguage.German, Slot: 5 } => "/quickchat <5> \"Ziel decken\"",
        { Kind: ReviewedPvpCommandKind.GuardianCoveringTarget, Language: ClientLanguage.German, Slot: 6 } => "/quickchat <6> \"Ziel decken\"",
        { Kind: ReviewedPvpCommandKind.GuardianCoveringTarget, Language: ClientLanguage.German, Slot: 7 } => "/quickchat <7> \"Ziel decken\"",
        { Kind: ReviewedPvpCommandKind.GuardianCoveringTarget, Language: ClientLanguage.German, Slot: 8 } => "/quickchat <8> \"Ziel decken\"",
