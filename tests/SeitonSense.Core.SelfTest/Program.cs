...
var tests = new (string Name, Action Run)[]
{
    ...
    ("SAM Zantetsuken requires own Kuzushi and zero shield", SamuraiReactiveSelfTests.ZantetsukenRequiresOwnKuzushiAndZeroShield),
    ("SAM Zantetsuken ranks the farthest reachable eligible target", SamuraiReactiveSelfTests.ZantetsukenRanksFarthestReachableEligibleTargetThenSlot),
    ("SAM Zantetsuken farthest ranking fails closed", SamuraiReactiveSelfTests.ZantetsukenFarthestRankingFailsClosedAndRequiresReachability),
    ...
    ("SAM Ogi and Tendo protection shapes fail closed", SamuraiSmartActionCastSelfTests.OgiConeAndTendoDirectProtectionFailClosed),
