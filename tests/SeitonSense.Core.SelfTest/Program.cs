...
var tests = new (string Name, Action Run)[]
{
    ...
    ("Far Help preferred roles win before distance", FarHelpSelectionSelfTests.PreferredTierWinsBeforeDistance),
    ("Far Help selects the farthest actor inside a role tier", FarHelpSelectionSelfTests.FarthestWinsInsideEachTier),
    ...
    ("Far Help missing candidate uses exact carrier fallback", FarHelpOneShotSelfTests.MissingCandidateUsesExactCarrierFallbackPolicy),
