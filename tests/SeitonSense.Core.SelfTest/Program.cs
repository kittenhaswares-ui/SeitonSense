...
var tests = new (string Name, Action Run)[]
{
    ...
    ("Miracle follow-up key release retires the episode", MiracleCleanseFollowupSelfTests.ReservedKeyReleaseTerminallyCancelsEpisode),
    ...
    ("Guard follow-up snapshots key and early cancel", MiracleGuardFollowupSelfTests.ReservationSnapshotsFirstPresenceAndAllowsEarlyGuardCancel),
    ("Guard follow-up key release retires the episode", MiracleGuardFollowupSelfTests.ReservedKeyReleaseRetiresGuardEpisode),
