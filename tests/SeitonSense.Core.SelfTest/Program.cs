...
var tests = new (string Name, Action Run)[]
{
    ...
    ("Reactive CC follow-up requires fresh exact total-team focus", MiracleCleanseFollowupSelfTests.ExactTeamFocusWaitsInsideOriginalOpportunity),
    ...
    ("Guard follow-up team focus and priority window are bounded", MiracleGuardFollowupSelfTests.FreshTeamFocusAndPriorityWaitOnlyInsideOriginalWindow),
    ("Guard follow-up simultaneous release ranking is deterministic", MiracleGuardFollowupSelfTests.SimultaneousReleaseRanksHpThenSlotAndRetiresEveryOther),
