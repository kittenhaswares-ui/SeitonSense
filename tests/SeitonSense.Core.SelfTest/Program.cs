...
var tests = new (string Name, Action Run)[]
{
    ...
    ("Scholar spread metadata constants are exact", ScholarSpreadSelfTests.MetadataConstantsAreExact),
    ("Scholar spread has an independent held lane", ScholarSpreadSelfTests.IndependentHeldLaneNeverClaimsSharedInput),
