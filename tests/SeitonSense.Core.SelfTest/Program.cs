...
var tests = new (string Name, Action Run)[]
{
    ...
    ("NIN Seiton dispatch requires every gate and fresh input", NinjaSeitonDispatchSelfTests.DispatchRequiresEveryGateAndFreshPress),
    ("NIN Seiton dispatch freezes one exact intent", NinjaSeitonDispatchSelfTests.DispatchFreezesOneExactIntent),
    ("NIN Seiton dispatch cannot retry one physical generation", NinjaSeitonDispatchSelfTests.OnePhysicalGenerationCannotRetry),
    ...
    ("Ally Rescue dispatch consumes before native call", AllyRescueBufferSelfTests.SameFrameFreshDispatchConsumesBeforeCallAndNeverRetries),
    ("Ally Rescue buffer expires at 750 milliseconds", AllyRescueBufferSelfTests.BufferWaitsForReadinessAndExpiresAt750Milliseconds),
    ...
    ("Ally Rescue one key generation cannot cross replacements", AllyRescueBufferSelfTests.OnePhysicalGenerationCannotCrossActorOrStatusReplacement),
    ...
    ("Protection-end ranking is deterministic", MiracleProtectionEndSelfTests.RankingIsPressureThenHealthThenTrustedMpThenIdentity),
    ("WHM and BRD share protection-end semantics", MiracleProtectionEndSelfTests.WhiteMageAndBardShareProtectionEndSemantics),
    ("Reactive CC follow-up accepts only exact Purify-removable CC", MiracleCleanseFollowupSelfTests.ExactPurifySignalAcceptsOnlyKnownRemovableCrowdControl),
    ("Reactive CC follow-up retires unresolved Purify packets", MiracleCleanseFollowupSelfTests.ValidatedSignalRetiresBeforeCanonicalResolution),
    ...
    ("Guard follow-up simultaneous pressure ranking is deterministic", MiracleGuardFollowupSelfTests.SimultaneousReleaseRanksPressureThenHpAndRetiresEveryOther),
