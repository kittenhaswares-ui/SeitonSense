...
var tests = new (string Name, Action Run)[]
{
    ...
    ("Panic Shukuchi command freezes one exact lease", PanicShukuchiSelfTests.ArmFreezesExactIdentityContextAndDestination),
    ("Panic Shukuchi pending lease cannot be replaced", PanicShukuchiSelfTests.ExistingPendingCannotBeReplacedAndExpiryIsExact),
    ("Panic Shukuchi cast queue and lock waits preserve intent", PanicShukuchiSelfTests.CastQueueAndAnimationLockWaitWithoutDrift),
    ("Panic Shukuchi ready state spends before native attempt", PanicShukuchiSelfTests.ReadyConsumesBeforeTheSoleNativeAttempt),
    ("Panic Shukuchi pending drift fails closed", PanicShukuchiSelfTests.PendingDriftAndTerminalGatesFailClosed),
