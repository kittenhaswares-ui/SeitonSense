...
var tests = new (string Name, Action Run)[]
{
    ...
    ("only exact automatic Purify may cancel a cast without a key", HeldCastCancellationSelfTests.OnlyExactAutomaticPurifyMayBeKeyless),
    ...
    ("automatic Recuperate keeps the legacy retry cap", SmartRecuperateSelfTests.AutomaticFalseRetriesIgnoreHeldLatencyExpansion),
    ...
    ("Auto-Guard trigger popup is accepted only and deduplicated", DefensiveUtilitySelfTests.AutoGuardTriggerPopupIsAcceptedOnlyAndDeduplicated),
