...
var tests = new (string Name, Action Run)[]
{
    ...
    ("pre-Guard risk requires every exact gate", DefensiveUtilitySelfTests.PreGuardRiskRequiresEveryExactGate),
    ...
    ("Smart Kardia requires every held-key gate", SmartKardiaSelfTests.DispatchRequiresEveryHeldKeyAndSafetyGate),
    ("Smart Kardia freezes one exact intent", SmartKardiaSelfTests.FrozenIntentCannotRerankFallbackOrRetry),
    ("Smart Kardia cannot retry a consumed hold", SmartKardiaSelfTests.ConsumedPhysicalGenerationCannotRetry),
    ...
    ("Reactive CC follow-up requires exact local-plus-ally focus", MiracleCleanseFollowupSelfTests.ExactTeamFocusWaitsInsideOriginalOpportunity),
